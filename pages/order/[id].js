        ...
        <div className="container-fluid">
          {session.user.isAdmin ? (
            ...
            <Link href="/order-history">
              <button type="button" className="btn btn-link">
                <i className="bi bi-arrow-left"></i> back to order history
              </button>
            </Link>
          )}
              ...
              <div className="col-lg-8">
                  ...
                  <div className="card-body">
                    ...
                    {isDelivered ? (
                      <span className="badge bg-success">
                        Delivered at{" "}
                        {moment(new Date(deliveredAt)).format("MM/DD/YYYY")}
                      </span>
                    ) : (
                ...
                <div className="card payment-card">
                  <div className="card-body">
                    ...
                    {isPaid ? (
                      <span className="badge bg-success">
                        Paid on {moment(new Date(paidAt)).format("MM/DD/YYYY")}
                      </span>
                    ) : (
                            ...
                            <td>
                              <Link href={`/product/${item.slug}`}>
                                <Image
                                  ...
                                  width={80}
                                  height={60}
                                  alt={`Image of ${item.name} ${item.size}`}
                                />
                              </Link>
                            </td>
